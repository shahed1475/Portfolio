...
const contactOptions = [
  {
    title: "WhatsApp",
    value: "+880 1751-190312",
    href: "https://wa.me/8801751190312?text=Hi%20Fahad,%20I%20want%20to%20discuss%20an%20AI/SaaS%20project.",
    icon: MessageCircle,
...
export function Booking() {
  return (
    <section id="booking" className="py-32 relative overflow-hidden bg-background">
            ...
            <div className="grid gap-4">
              {contactOptions.map((option, idx) => (
                <motion.a
                  ...
                  whileHover={{ x: 5 }}
                  className="group flex items-center justify-between p-8 rounded-2xl bg-secondary border border-border transition-all duration-300"
                >
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-foreground font-bold text-lg tracking-tight">{option.value}</p>
                    </div>
                  </div>
          ...
          <div className="grid gap-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {expertise.map((item, idx) => (
                    <div
                        key={item.title}
                        className="p-8 rounded-2xl bg-card border border-border group hover:bg-secondary transition-all duration-300"
                    >
            ...
            <div className="p-10 rounded-3xl bg-foreground text-background flex items-center gap-8 shadow-2xl">
              <img 
              ...
              <div>
                ...
                <h3 className="text-xl font-bold tracking-tight">Fahad</h3>
