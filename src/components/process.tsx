...
export function Process() {
  return (
    <section id="process" className="py-32 relative overflow-hidden bg-secondary/30">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mb-16 text-center">
                <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-6">How I Build</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
                {PHASES.map((phase) => (
                    <div key={phase.num} className="space-y-4">
                        <div className="text-primary font-mono text-xs font-bold uppercase tracking-widest">Phase {phase.num}</div>
                        <h3 className="text-foreground font-bold text-xl">{phase.title}</h3>
